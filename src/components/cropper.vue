  ...
  <div id="demo" class="cropperImg">
    ...
    <div>
      ...
      <div style="opacity:0;width:360px;position:absolute;top:0;right:0;height:56px;">
        <input name="file" type="file" id="change" accept="image" @change="change" style="height:56px;">
  ...
  export default {
    ...
    methods: {
      ...
      postImg () {
        ...
        //console.log("url="+this.postHeaderImg)
        this.$http({
          method: 'post',
          url: 'api/upload/v1/uploadHeadImage',
          data:{headerImage:this.postHeaderImg},
          //params: param,
