    ...
    <x-header>商品详情</x-header>
	    ...
	    <div class="handle-box vux-1px-t">
	    	<div>
	    		...
	    		<div>
		    		<img src="../assets/images/icon-shopcar-active.png"/>
		    		<badge class="badge" text="1"></badge>
	    		</div>
	    	</div>
	    	<x-button link="/orderConfrim">立即购买</x-button>
	    </div>
	</div>
</template>

<script>
	import { Swiper, SwiperItem, Tab, TabItem, Badge ,XButton, XHeader} from 'vux'
